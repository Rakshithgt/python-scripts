...
def analyse_log_file(file_name):
    ip_count = {}
    status_count = {}
    error_count = {}
    ...
    return ip_count, status_count, error_count


def write_report(ip_count, status_count, error_count, report_file_name):
...
ip_count, status_count, error_count = analyse_log_file("access_log.txt")

write_report(ip_count, status_count, error_count, "log_analysis_functions_report.txt")

print("Log analysis report created: log_analysis_functions_report.txt")